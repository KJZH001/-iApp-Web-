...
<head>
  ...
  <title>晓空iApp手册Web版 MD5加密</title>
...
<!--最大容器 -->
  ...
  <!-- 基础网格 -->
	...
	<!-- 副标题 -->
    <a href="javascript:;" class="mdui-typo-title 去超链接下划线 mdui-text-color-white">MD5加密</a>
	</div>
	
    <!-- 标题自适应 小屏幕 -->
	<div class="mdui-hidden-sm-up">
	<!-- 标题 -->
    <a href="javascript:;" class="mdui-typo-title 去超链接下划线 mdui-text-color-white">晓空iApp手册-MD5</a>
	</div>
	...
	<div class="mdui-container">
			...
			<script src="https://cdn.bootcss.com/crypto-js/3.1.9-1/crypto-js.min.js"></script>
			  ...
			  function jiaMi()
			    ...
			    {
			    var content=document.getElementById("content").value;
				var result=CryptoJS.MD5.decrypt(content).toString(CryptoJS.enc.Utf8);
				document.getElementById("resultShow").innerHTML = 

...
<head>
  ...
  <title>晓空iApp手册Web版 HmacMD5加密</title>
...
<!--最大容器 -->
  ...
  <!-- 基础网格 -->
	...
	<!-- 副标题 -->
    <a href="javascript:;" class="mdui-typo-title 去超链接下划线 mdui-text-color-white">HmacMD5加密</a>
	</div>
	
    <!-- 标题自适应 小屏幕 -->
	<div class="mdui-hidden-sm-up">
	<!-- 标题 -->
    <a href="javascript:;" class="mdui-typo-title 去超链接下划线 mdui-text-color-white">晓空-HmacMD5</a>
	</div>
			  ...
			  function jiaMi()
			    {
					...
					//获取编辑框内容
  					...
  					var mi=CryptoJS.HmacMD5(content,password);
